...
async def echo(message):
    ...
    # var.save('/Users/rpe4a/apps/im_caption_bot/audio/audio.ogg')
    try:
        r = requests.post(
        ...
        with open('/Users/rpe4a/apps/im_caption_bot/audio/audio.ogg', 'wb') as f:
            f.write(r1.content)
    except:
        var = gTTS(text = result_ru,lang = 'ru') 
        var.save('/Users/rpe4a/apps/im_caption_bot/audio/audio.ogg')
    ...
    # media.attach_photo(dataBytesIO)
    # await  message.answer(result) 
    # await message.answer(___text)
    await message.answer_voice(types.InputFile(
        '/Users/rpe4a/apps/im_caption_bot/audio/audio.ogg'))
